<div
    id="formCard"
    class="bg-secondary stretch-on-mobile px-1h pe-auto px-md-1hq px-xl-2q py-md-1hq py-xl-3 rounded-md py-3"
>
    <h2 class="text-light fs-5 fs-md-6 fs-xl-4 fw-medium fs-3 fs-md-5 fs-xl-3 ls-xl mb-0">
        Fale com nossos consultores
        <span class="text-info"> e garanta o seu terreno </span>
    </h2>
    <form wire:submit.prevent="submit" class="needs-validation" novalidate>
        <div class="row gx-0 gy-1h gy-md-0hq gy-xl-1h">
            ...
            <div class="col-12">
                <div class="form-check mt-0h mb-1">
                    <input
                        ...
                        id="privacy-terms"
                    />
                    <label class="form-check-label" for="privacy-terms">
            ...
            <div class="col-12">
                ...
                >
                    <span wire:loading.remove wire:target="submit">Quero saber mais </span>
