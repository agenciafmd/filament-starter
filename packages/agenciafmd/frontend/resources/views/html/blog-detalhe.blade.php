            ...
            <div class="container">
                ...
                <div class="row gy-block-small">
                    <div class="col-md-5 col-xl-6 align-self-center">
                        <div class="vstack">
                            <span class="fw-semibold text-primary"> Categoria </span>
                            <h1 class="mb-block-small h2">Lorem ipsum dolor sit amet consectetur suspendisse lacus</h1>
                ...
                <div class="row g-block-small gx-xl-block-large justify-content-between">
                    <div class="col-md-7">
                        <div class="mb-block-small wysiwyg">
                            <h2>Título grande</h2>
                            <p>
                                Lorem ipsum dolor sit amet consectetur. Mattis morbi tellus purus tincidunt sagittis.
                                Pellentesque quis feugiat pellentesque eget interdum. Dui ut at dignissim neque praesent
                                ridiculus. Lectus arcu mauris elementum sit id ut eu metus feugiat.
                            </p>
                            <p>
                                Vulputate suscipit turpis ultrices tristique iaculis penatibus. Malesuada a sem eget id.
                                Sed a consectetur eget feugiat. Sed tincidunt purus aliquam lectus. Urna orci at mattis
                                non. Sed faucibus consectetur quis et id bibendum dictum orci morbi. Natoque sem et enim
                                ligula neque amet. Id diam porta id diam leo.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="swiper-container">
                                ...
                                <x-frontend::sliders.articles-gallery
                                    gallery-name="articles-gallery"
                                    :galleries="$gallery"
                                />
                    ...
                    <div class="col-md-4">
                        ...
                        <x-frontend::cards.card
                            class="position-sticky top-0 h-auto bg-gray-100 shadow"
