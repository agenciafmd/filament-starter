    ...
    <div class="swiper-wrapper">
        @foreach ($galleries->video as $video)
            <div class="swiper-slide">
                ...
                <p class="fs-small text-dark mt-1 px-1">{{ $video->name }}</p>
            </div>
        ...
        @foreach ($galleries->images as $image)
            <div class="swiper-slide">
                ...
                >
                    ...
                    />
                    <p class="fs-small text-dark mt-1 px-1">{{ $image->name }}</p>
                </x-frontend::glightbox.image>
            </div>
...
@push('scripts')
    <script type="module" src="{{ Vite::asset('resources/js/components/sliders/articles.js') }}"></script>
