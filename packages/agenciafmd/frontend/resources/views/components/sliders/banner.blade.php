...
<section id="banner" class="banner-slider overflow-hidden">
    <div class="swiper-container">
        <div id="js-slider-banners" class="swiper overflow-md-hidden overflow-visible">
                        ...
                        <div class="grid-default h-100">
                            ...
                            @if ($banner->content)
                                <div class="grid-default-content position-relative vstack pe-none">
                                    <div class="vstack justify-content-end flex-grow-1">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-7 col-xl-6">
                                                    <div class="mb-block-small pe-auto">
                                                        <h2 class="text-primary">{{ $banner->content->name }}</h2>
                                                            ...
                                                            <div class="row gy-2 align-items-center">
                                                                <div class="col-md-9">
                                                                    <x-frontend::list-icon
                                                                        ...
                                                                        class="row gx-0 gy-1 fs-small text-primary mb-0"
                                                                        list-class="col-md-6"
            ...
            <div class="mb-block-small position-absolute pe-none start-0 end-0 bottom-0">
                <div class="container">
                    <x-frontend::swiper-buttons
                        swiper-button-class="hstack gap-0h justify-content-end swiper-button-block pe-auto"
...
@push('scripts')
    <script type="module" src="{{ Vite::asset('resources/js/components/sliders/banners.js') }}"></script>
